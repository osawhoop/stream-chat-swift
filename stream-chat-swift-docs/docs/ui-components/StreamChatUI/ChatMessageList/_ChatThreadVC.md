...
[`ChatMessageContentViewDelegate`](/ChatMessageContentViewDelegate), `ComposerVCDelegate`, `ThemeProvider`, `UICollectionViewDataSource`, `UICollectionViewDelegate`, `_ChatChannelControllerDelegate`, `_ChatMessageActionsVCDelegate`, `_ChatMessageControllerDelegate`, `_ViewController`
