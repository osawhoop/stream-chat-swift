...
open class _ImageGalleryVC<ExtraData: ExtraDataTypes>:
    ...
    /// Date formatter for showing when the message was sent.
    public private(set) lazy var dateFormatter: DateFormatter = {
    ...
    public private(set) lazy var closeButton = _CloseButton<ExtraData>()
    
    /// Button for sharing content.
    public private(set) lazy var shareButton = _ShareButton<ExtraData>()
    ...
    override open func updateContent() {
        ...
        dateLabel.text = L10n.sent + " " + dateFormatter.string(from: content.createdAt).firstLowercased
