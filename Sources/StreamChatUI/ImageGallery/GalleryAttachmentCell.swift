...
public typealias GalleryAttachmentCell = _GalleryAttachmentCell<NoExtraData>

/// `UICollectionViewCell` for a single image.
open class _GalleryAttachmentCell<ExtraData: ExtraDataTypes>: _CollectionViewCell, UIScrollViewDelegate, ComponentsProvider {
