...
public struct _Components<ExtraData: ExtraDataTypes> {
    ...
    /// A view that displays the video attachment preview.
    public var messageComposerVideoAttachmentView: _VideoAttachmentComposerView<ExtraData>
        .Type = _VideoAttachmentComposerView<ExtraData>.self
