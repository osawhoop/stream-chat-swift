...
public typealias VideoAttachmentComposerView = _VideoAttachmentComposerView<NoExtraData>

/// A view that displays the video attachment preview in composer.
open class _VideoAttachmentComposerView<ExtraData: ExtraDataTypes>: _View, ThemeProvider {
