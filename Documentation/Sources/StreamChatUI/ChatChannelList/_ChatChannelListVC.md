...
`DataControllerStateDelegate`, [`SwipeableViewDelegate`](/SwipeableViewDelegate), `ThemeProvider`, `UICollectionViewDataSource`, `UICollectionViewDelegate`, `_ChatChannelListControllerDelegate`, `_ViewController`
